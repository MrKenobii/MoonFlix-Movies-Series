...
const SignupForm = ({ switchAuthState }) => {
    ...
    const signupForm = useFormik({
        ...
        validationSchema: Yup.object({
            username: Yup.string().min(8, "username must be minimum 8 characters").required("username is required"),
            password: Yup.string().min(8, "password must be minimum 8 characters").required("password is required"),
            displayName: Yup.string().min(8, "displayName must be minimum 8 characters").required("displayName is required"),
